...
<div class="container px-6 py-8 mx-auto">
    ...
    <div class="mt-4">
        <div class="flex flex-wrap -mx-6 ">
            <a class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
                <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                    ...
                    <div class="mx-3">
                        <h4 class="text-2xl font-semibold text-gray-700">100000</h4>
                        <div class="text-gray-500">Data Barang</div>
                    </div>
                </div>
            </a>
            <a class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            ...
            <a class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
                <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                    ...
                    <div class="mx-3">
                        <h4 class="text-2xl font-semibold text-gray-700">100000</h4>
                        <div class="text-gray-500">Barang Habis</div>
                    </div>
                </div>
            </a>
